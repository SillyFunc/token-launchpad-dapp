...
export const CONTRACT_ERROR_MESSAGES: Record<string, string> = {
  ...
  '0xe87ff4be': '该代币未开启预售',
  PresaleEnabled: '预售模式下不能领取全部托管代币',
  '0xee64016a': '预售模式下不能领取全部托管代币',
  InvalidPrice: '预售代币价格必须大于 0',
  '0x00bfc921': '预售代币价格必须大于 0',
  InvalidMaxPresaleTokens: '预售认购上限必须在 1 至预售份额之间',
  '0x5668bc6c': '预售认购上限必须在 1 至预售份额之间',
  AllocationMismatch: '托管资产与应付份额不守恒',
  '0x6d501ff8': '托管资产与应付份额不守恒',
  ZeroAllocationShare: '创建者/底池/预售任一份额为 0',
  '0x535f6940': '创建者/底池/预售任一份额为 0',
  PairAlreadyInitialized: '流动性池已存在 LP 供应量',
  '0xda3d3821': '流动性池已存在 LP 供应量',
  ...
  TokenNotSet: '托管仓未绑定代币，无法重开预售',
  '0x4b62f013': '托管仓未绑定代币，无法重开预售',
  EscrowDrained: '代币已回收，无法重开',
  '0x174a9bcf': '代币已回收，无法重开',
  OwnableUnauthorizedAccount: '仅预售创建者钱包可执行此操作',
  '0x118cdaa7': '仅预售创建者钱包可执行此操作',
  ...
  CreatorBuyTooLarge: '创建者购买超出底池 5% 上限',
  '0x452a0e78': '创建者购买超出底池 5% 上限',
